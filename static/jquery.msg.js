...
;( function( $, doc ){
  ...
  $.msg = function(){
    ...
    configs = $.extend({
      ...
      /* Edit Gabriele Di Bari */
      // default enableBlackGround
      enableBg : true,
    ...
    if( type === '[object String]' ){
      ...
      $overlay = $(
        '<div id="jquery-msg-overlay" class="' + configs.klass +'" style="position:absolute; z-index:' + configs.z + '; top:0px; right:0px; left:0px; height:' + $( doc ).height() + 'px;">' +
          (configs.enableBg ? '<img src="' + configs.bgPath + 'blank.gif" id="jquery-msg-bg" style="width: 100%; height: 100%; top: 0px; left: 0px;"/>' : '')+
